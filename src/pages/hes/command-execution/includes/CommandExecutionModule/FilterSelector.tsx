    ...
    return (
        <div className="flex border-b border-gray-300 space-x-8 my-5">
            <Button
                ...
                className={cn('hover:bg-[none] hover:text-[#0A3690] font-lg font-medium text-[#464E5F] rounded-none', 
                    selected === "pss" && "text-[#0A3690] font-bold border-b-[3px] border-[#0A3690]")}
            >
            ...
            <Button
                ...
                className={cn('hover:bg-[none] hover:text-[#0A3690] font-lg font-medium text-[#464E5F] rounded-none', 
                    selected === "feeder" && "text-[#0A3690] font-bold border-b-[3px] border-[#0A3690]")}
            >
                Feeder
            </Button>
            <Button
                ...
                className={cn('hover:bg-[none] hover:text-[#0A3690] font-lg font-medium text-[#464E5F] rounded-none', 
                    selected === "dtr" && "text-[#0A3690] font-bold border-b-[3px] border-[#0A3690]")}
            >
                DTR
            </Button>
            <Button
                ...
                className={cn('hover:bg-[none] hover:text-[#0A3690] font-lg font-medium text-[#464E5F] rounded-none', 
                    selected === null && "text-[#0A3690] font-bold border-b-[3px] border-[#0A3690]")}
            >
                Meter
            </Button>
        </div>
