...
const DayRangeBlockLoad = () => {
    ...
    const {
        ...
        searchQuery: getUrlSearchParams(query, "data_type=blockload-daily-metrics")
    });
    ...
    return (
        <DateTimeBarGraph 
            ...
            isError={isError} 
            error={error}
            data={data?.blockLoadDailyMetrics}
            dateStep='900'
            setQuery={setQuery}       
        />
    )
...
export default DayRangeBlockLoad